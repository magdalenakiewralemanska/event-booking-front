...
interface UpdateWeekScheduleProps {
  onClose: () => void;
  open: boolean;
  offer: Offer;
  onUpdate: (weekSchedule: DaySchedule[]) => void;
}

function UpdateWeekScheduleModal(props: UpdateWeekScheduleProps) {
  const { onClose, open, onUpdate, offer } = props;
              ...
              <Grid container p={2}>
                <Grid item xs={12} md={12}>
                  <Typography variant="h4" fontWeight="bold" sx={{ py: 5 }}>
                    Update you daily week schedule.
                  </Typography>
...
export default UpdateWeekScheduleModal;
